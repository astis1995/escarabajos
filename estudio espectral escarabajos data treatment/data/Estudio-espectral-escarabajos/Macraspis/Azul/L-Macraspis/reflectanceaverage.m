...
xlabel('\lambda (nm)');
ylabel('R (%)');
title(['Average reflectance for N=13 blue \textit{Macraspis} specimens,RHCP '], 'Interpreter', 'latex');
legend('std dev', 'Average', 'Average ± std dev');

hold off;

%%
writematrix(mean_data,"macraspis-blue-averageR.csv")
writematrix(std_data,"macraspis-blue-stdR.csv")
