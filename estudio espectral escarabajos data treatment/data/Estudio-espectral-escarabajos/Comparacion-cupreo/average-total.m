...
xlabel('\lambda (nm)');
ylabel('R (%)');
title('Average reflectance for N=6 \textit{C. cupreomarginata} specimens ','from Pacific and Central Valley regions, total', 'Interpreter', 'latex');
