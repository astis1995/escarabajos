...
xlabel('\lambda (nm)');
ylabel('R (%)');
title(['Average reflectance of the scutellum for N=2 \textit{Macraspis chrysis} specimens,LHCP '], 'Interpreter', 'latex');
legend('std dev', 'Average', 'Average ± std dev');

hold off;

%%
writematrix(mean_data,"macraspis-chrysis-averageL.csv")
writematrix(std_data,"macraspis-chrysis-stdL.csv")
