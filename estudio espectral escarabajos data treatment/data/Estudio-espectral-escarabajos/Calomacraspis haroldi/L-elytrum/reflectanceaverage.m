...
xlabel('\lambda (nm)');
ylabel('R (%)');
title('Average reflectance for N=20 \textit{Calomacraspis haroldi} specimens, elytrum, LHCP', 'Interpreter', 'latex');
...
writematrix(mean_data,"calomacraspis-elytrumL.csv")
writematrix(std_data,"calomacraspis-elytrum-stdL.csv")
