...
xlabel('\lambda (nm)');
ylabel('R (%)');
title('Average reflectance for N=20 \textit{Calomacraspis haroldi} specimens, elytrum, RHCP', 'Interpreter', 'latex');
...
writematrix(mean_data,"calomacraspis-elytrumR.csv")
writematrix(std_data,"calomacraspis-elytrum-stdR.csv")
