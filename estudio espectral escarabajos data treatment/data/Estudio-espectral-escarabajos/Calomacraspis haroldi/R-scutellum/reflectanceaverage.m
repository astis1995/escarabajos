...
xlabel('\lambda (nm)');
ylabel('R (%)');
title('Average reflectance for N=7 \textit{Calomacraspis haroldi} specimens,scutellum, RHCP', 'Interpreter', 'latex');
...
writematrix(mean_data,"calomacraspis-scutellumR.csv")
writematrix(std_data,"calomacraspis-scyteluum-stdR.csv")
