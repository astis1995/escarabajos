...
xlabel('\lambda (nm)');
ylabel('R (%)');
title('Average reflectance for N=7 \textit{Calomacraspis haroldi} specimens,scutellum, LHCP', 'Interpreter', 'latex');
...
writematrix(mean_data,"calomacraspis-scutellumL.csv")
writematrix(std_data,"calomacraspis-scyteluum-stdL.csv")
