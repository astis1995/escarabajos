...
xlabel('\lambda (nm)');
ylabel('R (%)');
title('Average reflectance for N=12 \textit{Calomacraspis haroldi} specimens, pronotum, LHCP', 'Interpreter', 'latex');
...
writematrix(mean_data,"calomacraspis-pronotumL.csv")
writematrix(std_data,"calomacraspis-pronotum-stdL.csv")
