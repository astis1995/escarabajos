...
class Spectrum:
    ...
    def __init__(self, file_location, collection=None, genus=None, species=None,
                 prominence_threshold_min=0.15, prominence_threshold_max=0.40,
                 min_height_threshold_denominator=3.0, max_height_threshold_denominator=3.3,
                 min_distance_between_peaks=160, max_distance_between_peaks=160,
                 min_wavelength=None, max_wavelength=None, equipment=None):
        ...
        self.genus = get_genus(self.code, collection) if not genus else genus
        self.species = get_species(self.code, collection) if not species else species
        self.min_wavelength = min_wavelength
        self.max_wavelength = max_wavelength
        self.peaklist = PeakList(self, prominence_threshold_min, prominence_threshold_max,
                                 min_height_threshold_denominator, max_height_threshold_denominator,
                                 min_distance_between_peaks, max_distance_between_peaks,
    ...
    def get_normalized_spectrum(self):
        df = self.data[["wavelength", self.measuring_mode]].copy()  # Explicit copy
    ...
    def get_maxima(self, min_wavelength=None, max_wavelength=None):
        return self.peaklist.get_maxima(self, min_wavelength, max_wavelength)

    def get_minima(self, min_wavelength=None, max_wavelength=None):
        return self.peaklist.get_minima(self, min_wavelength, max_wavelength)

    def get_critical_points(self, min_wavelength=None, max_wavelength=None):
        return self.peaklist.get_peaks(self, min_wavelength, max_wavelength)
