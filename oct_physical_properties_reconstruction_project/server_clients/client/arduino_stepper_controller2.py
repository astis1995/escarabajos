...
class ArduinoStepperController:
    def __init__(self, port='COM5', baud_rate=9600):
        ...
        self.arduino = None
        self.real_angle_per_program_angle_unit_cw = 1.0
        self.real_angle_per_program_angle_unit_ccw = 1.0
        self.real_angle_per_program_angle_unit_cw = 1 / self.real_angle_per_program_angle_unit_cw
        self.program_angle_per_real_angle_unit_cw = 1 / self.real_angle_per_program_angle_unit_ccw
    ...
    def listen_for_keys(self):
        ...
        while True:
            if keyboard.is_pressed('q'):  # If the 'Q' key is pressed
                self.rotate(1, -self.program_angle_per_real_angle_unit_ccw)  # Rotate counterclockwise by 0.5°
                time.sleep(0.5)  # Delay to prevent rapid firing
            elif keyboard.is_pressed('e'):  # If the 'E' key is pressed
                self.rotate(1, self.program_angle_per_real_angle_unit_cw)  # Rotate clockwise by 0.5°
                time.sleep(0.5)  # Delay to prevent rapid firing
